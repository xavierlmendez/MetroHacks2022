    ...
    return _regeneratorRuntime().async(function (_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _regeneratorRuntime().awrap(_Storage.default.getItemAsync(name));
    ...
    return _regeneratorRuntime().async(function (_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.next = 2;
            return _regeneratorRuntime().awrap(_Storage.default.getAllKeysAsync());
              ...
              return _regeneratorRuntime().async(function (_context2) {
                while (1) {
                  switch (_context2.prev = _context2.next) {
                    case 0:
                      _context2.next = 2;
                      return _regeneratorRuntime().awrap(previousPromise);
                    ...
                    case 2:
                      ...
                      _context2.next = 6;
                      return _regeneratorRuntime().awrap(_Storage.default.getItemAsync(key));
