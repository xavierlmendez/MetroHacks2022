    ...
    return _regeneratorRuntime().async(function (_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return _regeneratorRuntime().awrap(this.getQueue());
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.t0 = JSON;
            _context2.next = 4;
            return _regeneratorRuntime().awrap(this.load());
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 2:
            ...
            _context3.next = 8;
            return _regeneratorRuntime().awrap(this.setQueue(queueData));
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 7:
            ...
            _context5.next = 14;
            return _regeneratorRuntime().awrap(this.process.byId(ObjectType, queueObject));
          ...
          case 16:
            ...
            _context5.next = 19;
            return _regeneratorRuntime().awrap(this.process.byHash(ObjectType, queueObject));
          ...
          case 21:
            _context5.next = 23;
            return _regeneratorRuntime().awrap(this.process.create(ObjectType, queueObject));
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 7:
            _context6.prev = 7;
            _context6.next = 10;
            return _regeneratorRuntime().awrap(object.save(queueObject.object, queueObject.serverOptions));

          case 10:
            _context6.next = 12;
            return _regeneratorRuntime().awrap(this.remove(queueObject.queueId));
          ...
          case 20:
            _context6.prev = 20;
            _context6.next = 23;
            return _regeneratorRuntime().awrap(object.destroy(queueObject.serverOptions));
        ...
        while (1) {
          switch (_context7.prev = _context7.next) {
            case 0:
              ...
              _context7.next = 5;
              return _regeneratorRuntime().awrap(query.find({
